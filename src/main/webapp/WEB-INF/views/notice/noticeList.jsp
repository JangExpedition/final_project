			...
			<div class="col-detail">
				...
				<form:form action="${pageContext.request.contextPath}/notice/searchNotice" method="get" class="mb-3">
					<div class="input-group">
						...
						<input type="text" class="form-control" id="myElement" placeholder="제목 검색"
				...
				<div class="c_tab_wrap">
					<ul class="c_tab type_free">
						...
						<li class=''><a
								href="${ pageContext.request.contextPath }/notice/searchNotice?searchType=title&title=점검">시스템점검</a>
						</li>
						<li class=''><a
								href="${ pageContext.request.contextPath }/notice/searchNotice?searchType=title&title=극장">극장</a>
						</li>
						<li class=''><a
								href="${ pageContext.request.contextPath }/notice/searchNotice?searchType=title&title=행사">행사/이벤트</a>
						</li>
						<li class=''><a
								href="${ pageContext.request.contextPath }/notice/searchNotice?searchType=title&title=제휴">제휴이벤트</a>
						</li>
						<li class=''><a
								href="${ pageContext.request.contextPath }/notice/searchNotice?searchType=title&title=기타">기타</a>
						</li>
					</ul>
				</div>
