...
<div id="movie-container">
	<form name="movieFrm" action="${pageContext.request.contextPath}/movie/movieEnroll.do" method="post" enctype="multipart/form-data">
		...
		<input type="text" class="form-control" placeholder="출연진" name="title" id="title" required>
		<input type="text" class="form-control" placeholder="감독" name="title" id="title" required>
		<input type="text" class="form-control" placeholder="시놉시스" name="title" id="title" required>
