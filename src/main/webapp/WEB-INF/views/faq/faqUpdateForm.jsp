...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAOD9Aa/hRH7d0EBA0LTEkADzsWOb8UHrO0G5mb2BT/k3qQMw9640ReXn/4OZAmFom+g4xvzZiuWB3aX6N7Pf6f/O6xK3w==" />
			    ...
			    <form:form 
			    		name="faqFrm" 
			    		action="${pageContext.request.contextPath}/faq/updateFaq.do" 
			    		method="post">
                    ...
                    <fieldset>
						...
						<div class="tbl_area">
							...
							<table cellspacing="0" cellpadding="0" class="tbl_notice_list tbl_left">
								...
								<tbody>
									<tr>
										<th scope="row"><label for="inp_title" value="${faq.title}" >제목 <em><img src="http://img.cgv.co.kr/R2014/images/common/ico/ico_redstar.png" alt="필수" /></em></label></th>
										<td colspan="3">
											<input type="text" id="title" name="title" class="inp01" style="width: 672px;" value="${faq.title}"/>
										</td>
									</tr>
						...
						<div class="box-btn qna_email">
							<%-- a style="margin-left:5px" href="${pageContext.request.contextPath}/faq/faqUpdate.do" class="round gray"><span style="padding:0 14px;">취소</span></a> --%>
                            <button style="width:80px" class="round inred" type="submit"><span>수정하기</span></button>
						</div>
					</fieldset>
				</form:form>
			</div>
