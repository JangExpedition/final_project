	...
	<div class="cols-content">
		...
		<div class="col-detail">
			<div class="email_list_area">
				...
				<form:form name="questionFrm" action="${pageContext.request.contextPath}/question/questionEnroll.do"
					method="POST">
								...
								<tbody>
									...
									<tr class="check_info">
										<td colspan="4">
											...
											<div class="desc_miso">
												<p class="desc_txt1">고객님의 문의에 답변하는 직원은 <em>고객 여러분의 가족 중 한 사람</em>일 수
													있습니다.</p>
												<p class="desc_txt2">저희 J3L은 고객의 언어폭력(비하, 욕설, 반말, 성희롱 등)으로부터 고객상담직원을
													보호하기 위해<br />관련 법에 따라 수사기관에 필요한 조치를요구할 수 있으며, 형법에 의해 처벌 대상이 될 수
													있습니다.</p>
											</div>
										</td>
									</tr>
									<tr>
										<th scope="row">문의유형 <img
												src="${ pageContext.request.contextPath }/resources/images/ico_redstar.png" />
										</th>
										<td colspan="3">
									...
									<tr>
										<th scope="row"><label for="title">제목<img
													src="${ pageContext.request.contextPath }/resources/images/ico_redstar.png" /></label>
										</th>
										<td colspan="3">
									...
									<tr>
										<th scope="row"><label for="inp_textbox">내용<img
													src="${ pageContext.request.contextPath }/resources/images/ico_redstar.png" /></label>
										</th>
										<td colspan="3">
