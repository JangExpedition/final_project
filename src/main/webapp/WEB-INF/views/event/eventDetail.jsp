		...
		<div class="col-detail">
			...
			<div class="board_view_area">
				<ul class="top_title_faq">
					<li class="title">${eventList.category.krName} ${eventList.title}</li>
					<li class="stit_area">
						<span>등록일<em class="regist_day"></em></span>
								<fmt:parseDate value="${eventList.createdAt}" pattern="yyyy-MM-dd" var="createdAt" />
				...
				<div class="button-group">
					...
					<div class="button2">
						<form:form name="noticeDeleteFrm"
							...
							<input type="hidden" name="no" value="${eventList.no}" />
