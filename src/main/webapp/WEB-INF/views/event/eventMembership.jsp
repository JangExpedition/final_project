...
<link rel="stylesheet" href="${ pageContext.request.contextPath }/resources/css/eventMembership.css" />
...
<div id="contents">
    ...
    <div class="evt-nav-area">
        <ul class="evt-tab-menu">
            ...
            <li><a href="${ pageContext.request.contextPath }/event/eventMembership.do" title="" class="on">멤버십/CLUB</a></li>
